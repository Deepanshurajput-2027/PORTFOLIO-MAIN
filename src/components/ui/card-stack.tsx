  ...
  return (
    ...
    >
      ...
      <div className="mt-8 flex items-center justify-center gap-4">
        ...
        >
          <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-neutral-900/60 border border-white/10 flex items-center justify-center pointer-events-auto backdrop-blur-md hover:bg-yellow-500/20 hover:border-yellow-500/50 hover:scale-110 transition-all duration-300 text-white hover:text-yellow-400 shadow-2xl">
            <svg
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on ? "bg-yellow-400" : "bg-yellow-400/30 hover:bg-yellow-400/50",
                  )}
